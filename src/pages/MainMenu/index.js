  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        await Api.post('/products/New', Json);
  ...
  useEffect(() => {
    async function fetchFinanceData() {
      try {
        ...
        let NewBalance =
          parseFloat(currentBalance) - parseFloat(balanceData.Expense);
    ...
    <View style={{flex: 1, backgroundColor: '#68293f'}}>
      ...
      <View style={styles.Center}>
        <MenuButton
          Type={'Large'}
          IconSvg={Finances}
          OnPress={() => setRoad('Finances')}
          Name={'Dados Financeiros'}
        />
        <MenuButton
          Type={'Large'}
          IconSvg={Add}
          OnPress={() => setRoad('Sales')}
          Name={'Adicionar Vendas'}
        />
      </View>
      <View
        style={{
